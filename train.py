...
def train_model(data_path, epochs=10, test_size=0.2):
    ...
    train_generator = datagen.flow_from_directory(data_path, target_size=(256, 256), batch_size=64, class_mode='categorical', subset='training')
    validation_generator = datagen.flow_from_directory(data_path, target_size=(256, 256), batch_size=64, class_mode='categorical', subset='validation')
